...
<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-dark bg-dark">
          ...
          <hr>
          <center>
              <div class="card mb-4" style="max-width: 840px;">
                  <div class="row g-0">
                      <div class="col-md-4">
                      <img src="data:imagen/jpg;base64,<?php echo base64_encode($fila['3'])?>" class="card-img-top" alt="">
                      </div>
                      <div class="col-md-8">
                          <div class="card-body">
                              ...
                              <p><a href="carro_compra.php?id=<?php echo $fila['0'];?>" class="buy-now btn btn-sm btn-primary">agregar al  carro</a></p>
                          </div>
                      </div>
                  </div>
              </div>
