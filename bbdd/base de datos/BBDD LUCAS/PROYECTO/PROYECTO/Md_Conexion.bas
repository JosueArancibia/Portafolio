...
Public Function Conecta()
    ...
    ODBCConnectaAIEP = "PROVIDER = MSDASQL;driver = {SQL Server};server = " & Nombre_Servidor_SQl & ";uid=" & Usuario_SQL & ";pwd=" & C_Pass & ";database = BD_AIEP;"
    ...
    ConectaAIEP.Open "PROVIDER=MSDASQL;driver={SQL Server};server=" & Nombre_Servidor_SQl & ";uid=" & Usuario_SQL & ";pwd=" & C_Pass & ";database = BD_AIEP;"
    mConnectionStringAIEP = "PROVIDER=MSDASQL;driver={SQL Server};server=" & Nombre_Servidor_SQl & ";uid=" & Usuario_SQL & ";pwd=" & C_Pass & ";database = BD_AIEP;"
