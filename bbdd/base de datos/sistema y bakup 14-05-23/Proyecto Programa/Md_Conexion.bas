...
Public Function Conecta()
    ...
    Nombre_Servidor_SQl = "LAPTOP-OH4H0G3K"
    Usuario_SQL = "sa"
    C_Pass = "1234"
    
    ' VARIABLES DE CONEXION
    ConexionSistema = "Conexion AIEP"
    ODBCConnectaAIEP = "PROVIDER = MSDASQL;driver = {SQL Server};server = " & Nombre_Servidor_SQl & ";uid=" & Usuario_SQL & ";pwd=" & C_Pass & ";database = BD_AIEP_JOSUE;"
    ...
    ConectaAIEP.Open "PROVIDER=MSDASQL;driver={SQL Server};server=" & Nombre_Servidor_SQl & ";uid=" & Usuario_SQL & ";pwd=" & C_Pass & ";database = BD_AIEP_JOSUE;"
    mConnectionStringAIEP = "PROVIDER=MSDASQL;driver={SQL Server};server=" & Nombre_Servidor_SQl & ";uid=" & Usuario_SQL & ";pwd=" & C_Pass & ";database = BD_AIEP_JOSUE;"
