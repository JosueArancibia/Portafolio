...
'On Error GoTo controlarerror
  SQL = ""
    ...
    If txt_correousuario.Text = "" Then
    ...
    End If
        'verificaciones de otros campos
    If txt_tipodeusuario.Text = "" Then
        MsgBox "llene todos los datos pedidos en el formulario", vbInformation, "Datos vacios"
        Exit Sub
        txt_tipodeusuario.SetFocus
        
    End If
            'verificaciones de otros campos
    If txt_niveldeacceso.Text = "" Then
        MsgBox "llene todos los datos pedidos en el formulario", vbInformation, "Datos vacios"
        Exit Sub
        txt_niveldeacceso.SetFocus
